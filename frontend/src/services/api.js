...
export const demandeService = {
  ...
  justifier: (id, justification) => api.post(`/demandes/${id}/justifier`, { justification_urgence: justification }),
  accepterJustification: (id, acceptee) => api.put(`/demandes/${id}/accepter-justification`, { acceptee }),
